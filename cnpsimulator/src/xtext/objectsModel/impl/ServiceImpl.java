...
public class ServiceImpl extends MinimalEObjectImpl.Container implements Service
{
  ...
  {
    return ObjectsModelPackage.Literals.SERVICE;
  }
  ...
  public void setId(int newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ObjectsModelPackage.SERVICE__ID, oldId, id));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ObjectsModelPackage.SERVICE__NAME, oldName, name));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ObjectsModelPackage.SERVICE__DESCRIPTION, oldDescription, description));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ObjectsModelPackage.SERVICE__ID:
        return getId();
      case ObjectsModelPackage.SERVICE__NAME:
        return getName();
