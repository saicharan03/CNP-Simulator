 ...
 * <ul>
 *   <li>{@link xtext.objectsModel.WorkItemType#getName <em>Name</em>}</li>
 ...
 * </p>
 *
 * @see xtext.objectsModel.ObjectsModelPackage#getWorkItemType()
 * @model
 * @generated
 */
public interface WorkItemType extends EObject
{
   ...
   * @see #setName(String)
   * @see xtext.objectsModel.ObjectsModelPackage#getWorkItemType_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link xtext.objectsModel.WorkItemType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setId(int)
   * @see xtext.objectsModel.ObjectsModelPackage#getWorkItemType_Id()
   * @model
   * @generated
   */
  int getId();
  ...
  /**
   * Sets the value of the '{@link xtext.objectsModel.WorkItemType#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see xtext.objectsModel.ObjectsModelPackage#getWorkItemType_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link xtext.objectsModel.WorkItemType#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see xtext.objectsModel.ObjectsModelPackage#getWorkItemType_Hierarchy()
   * @model
   * @generated
   */
  int getHierarchy();
  ...
  /**
   * Sets the value of the '{@link xtext.objectsModel.WorkItemType#getHierarchy <em>Hierarchy</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
